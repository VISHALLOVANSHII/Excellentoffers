...
const Hero = () => {
  return (
    <>
      {/* Hero Section */}
      <section id="hero" className="relative text-white overflow-hidden h-screen sm:h-screen">
        ...
        <div className="container mx-auto lg:px-12 px-5 py-24 md:py-32 relative z-10 lg:h-[90vh]">
          <div className="flex flex-col md:flex-row items-center justify-around">
            ...
            <div className="w-full md:w-1/2 mb-12 md:mb-0 relative">
              ...
              <p className="mb-5 text-gray-300 text-sm sm:text-base">
                At ExcellentOffers we review and approve brands in credit monitoring, credit score improvement, cybersecurity,
                nutraceuticals, weight loss, and other product categories.
              </p>
              <Link to="/partnerOffers">
            ...
            <div className="w-full md:w-2/5 md:pl-12 sm:h-auto">
              <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg relative rounded-xl p-6 sm:p-8 shadow-2xl h-full">
                <h2 className="text-2xl font-semibold text-blue-800 mb-6">Why Choose Us?</h2>
                <img src={logo} alt="Logo" className="h-12 absolute top-4 right-4 hidden md:block" />
                <ul className="space-y-4 text-sm sm:text-base">
                  <li className="flex items-start">
                    <span className="text-black">
                      <span className="text-fuchsia-900 font-semibold">🔍 Thorough Research:</span> We do the legwork on subscribing and testing out advertiser brands — so you don’t have to. If a brand appears on our site, you'll have full confidence in knowing it was reviewed and approved by our team first before recommending it to you.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-black">
                      <span className="text-fuchsia-900 font-semibold">🛡️ Campaign Categories:</span> Credit monitoring, credit score improvement, cybersecurity, nutraceuticals, weight loss, and other current or emerging product categories.

                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-black">
                      <span className="text-fuchsia-900 font-semibold">📂 Spotlight Pages:</span> Brands are organized by category for a quick comparison, exploration, and registration.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg p-4 sm:p-10">
              ...
              <p className="mt-4 text-gray-600 text-sm sm:text-lg">
                Welcome to ExcellentOffers — your trusted source for curated deals in credit monitoring, identity theft protection,
                nutraceuticals, and more. We research and review third-party services so you can make confident choices.
              </p>
              <div className="mt-8">
                <Link to="/about">
                  <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="mt-12 md:mt-0">
              <img src={couple} alt="About Us" className="object-cover rounded-lg shadow-md w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
